...
class Email
{
    ...
    function sendEmailRecuperar($investigador, $dynamicLink, $idioma)
    {
        try {
            ...
            $this->buildBody("recover", $saludo, $mensaje, $footer, $dynamicLink, $boton);
    ...
    function sendEmailActivation($investigador)
    {
        try {
            ...
            $titulo = "Account activated";
            $saludo = "Hello " . $investigador['nombre'] . " " . $investigador['apellido'] . "!";
            $mensaje = "Your account has been activated by administrators, now you can log-in in the app.";
            $footer = "Thanks,<br>
            Administration, App - A day in the life of ...";
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" style="border-radius: 18px;" bgcolor="#fb8c00">
                              <a href="' . $link . '" style="font-size: 14px; font-family: sans-serif; color: #ffffff; text-decoration: none; border-radius: 18px; padding: 5px 16px; border: 1px solid #fb8c00; display: inline-block; box-shadow: 0 2px 3px 0 rgba(0,0,0,0.10);">
                                <!--[if mso]> <![endif]-->
                                ' . $boton . '
                                <!--[if mso]> <![endif]-->
                              </a>
                        ...
                        <td align="center" valign="top">
                            <table width="640" cellspacing="0" cellpadding="0" bgcolor="#ffffff" class="100p" style="border-radius: 8px; border: 1px solid #E2E5E7; overflow:hidden;">
                                ...
                                <tr>
                                    ...
                                    <td width="640" class="100p center" height="10" align="center" valign="top">
